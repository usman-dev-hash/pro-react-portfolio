                ...
                <div className="flex justify-center items-center">
                    <form action="" className="flex flex-col w-full md:w-1/2">
                        ...
                        <input type={'text'}
                               ...
                               className={"p-2 mb-1 bg-transparent border-2 text-white focus:outline-none rounded-md"}
                        />
                        <input type={'text'}
                               name={"email"}
                               ...
                               className={"p-2 mb-1 bg-transparent border-2 text-white focus:outline-none rounded-md"}
                        />
                        <textarea className="p-2 bg-transparent border-2 rounded-md text-white focus:outline-none"
